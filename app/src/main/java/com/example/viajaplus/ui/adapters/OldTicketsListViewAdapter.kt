...
class OldTicketsListViewAdapter(private val context: Context, private val routes: List<Ticket>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        //TODO: mostrar la fecha de cuando es el ticket y Cuando se ha comprado!
        ...
        holder.btnComprar.setOnClickListener {
            //TODO: Enviar a otra vista en la que pueda ver el boleto, simular una foto de un QR solo por poner algo en esa vista
